$(function () {
    ...
    function feiru() {
        if ((leng - 1) > i) {
			...
			$('.begin').html('<a href="MemoriesNew.html" style="text-decoration: none;color: #fff;background: pink;display: inline-block;padding: 10px;border: 2px solid #fff;">开启真挚的祝福吧</a>');
